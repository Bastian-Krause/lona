...
from schmona.compat import get_use_future_node_classes
from schmona.html.abstract_node import AbstractNode
from schmona.html.nodes.text_content import Div
from schmona.html.text_node import TextNode
...
class NodeHTMLParser(HTMLParser):
    ...
    def _setup_node_classes_cache(cls):
        ...
        from schmona.html import FUTURE_NODE_CLASSES as _FUTURE_NODE_CLASSES
        from schmona.html import INPUT_NODE_CLASSES as _INPUT_NODE_CLASSES
        from schmona.html import SELF_CLOSING_TAGS as _SELF_CLOSING_TAGS
        from schmona.html import NODE_CLASSES as _NODE_CLASSES
